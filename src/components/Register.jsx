                                    ...
                                    <div class="card-body">
                                        <form onSubmit={onFormSubmit}>
                                            ...
                                            <div class = "form-group">
                                                ...
                                                <input type="email" class="form-control" id="formControlEmail" placeholder="something@something.com" name="email" onChange={e => setEmailAddress(e.target.value)}/>
                                            </div>
                                            <div class = "form-group">
                                                <label for="formControlFullName">Full Name</label>
                                                <input type="fullName" class="form-control" id="formControlFullName" placeholder="John Smith" name="fullName" onChange={e => setFullName(e.target.value)}/>
                                            </div>
                                            <div class = "form-group">
                                                <label for="FormControlPassword">Password</label>
                                                <input type="password" class="form-control" id="FormControlPassword" placeholder="******" name="password1" onChange={e => setPassword(e.target.value)}/>
                                            </div>
                                            <div class = "form-group">
                                                <label for="FormControlPassword">Confirm Password</label>
                                                <input type="password" class="form-control" id="FormControlPassword" placeholder="******" name="password2" onChange={e => setConfPassword(e.target.value)}/>
                                            </div>
                                            <div class = "form-group">
                                                <center>
