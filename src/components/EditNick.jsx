            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card text-white bg-secondary mb-3">
                        <div class="card-header">Change The NickName Associated With Your Account</div>
                        <div class="card-body">
                            <form onSubmit={onFormSubmit}>
                                <div class="form-group">
                                    <label for="nameChange">Please Enter Your New Nick Name</label>
                                    <input type="nameChange" class="form-control" id="nameChange" aria-describedby="nameChange" placeholder="Enter New Name" onChange={(e) => setnickName(e.target.value)}/>
                                </div>
                                <div class="form-group">
                                    <label for="nameChangeConf">Please Confirm Your New Nick Name</label>
